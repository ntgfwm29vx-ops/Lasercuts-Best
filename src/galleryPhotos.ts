export const galleryPhotos = [
  {
    ...
    src: '/images/gallery/recent-mulch-job.png',
  ...
  },
  {
    ...
    src: '/images/gallery/lawn-care-before-after.png',
  ...
  {
    slug: 'weed-spraying',
    src: '/images/gallery/weed-spraying-before-after.png',
  ...
  },
  {
    ...
    src: '/images/gallery/tree-planting-mulch-ring.png',
...
export const galleryAlbums: Record<string, Array<{ src: string; alt: string }>> = {
  'before-and-after': [
    ...
    ...Array.from({ length: 27 }, (_, index) => {
      ...
      return {
        src: `/images/gallery/before-and-after/mowing-${paddedNumber}.jpeg`,
