...
const mowingPackages: readonly MowingPackage[] = [
  ...
  },
  {
    ...
    title: 'Complete Cut',
    price: '$50',
    description: 'Includes Basic Cut plus more detailed weed eating and cleanup.',
    features: [
      'Everything in Basic Cut',
      'Detailed weed eating around landscaping, fences, and obstacles',
      'Extra cleanup around landscaping and hard surfaces',
    ],
    badge: 'Most Popular',
  ...
  },
  {
    ...
    price: '$60',
    description: 'Includes Complete Cut with the most detailed cleanup and finish work.',
    features: [
      'Everything in Complete Cut',
      'Detailed weed eating around landscape beds and trees',
      'Enhanced clipping cleanup from landscaping and hard surfaces',
